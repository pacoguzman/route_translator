...
class TranslatorControllerTest < ActionController::TestCase
  ...
  def test_unnamed_translated_route_on_default_locale
    ...
    with_routing do |set|
      set.draw { get 'people', to: 'people#index' }
      set.draw do
        localized do
          get 'people', to: 'people#index'
        end
  ...
  def test_named_translated_route_on_default_locale_without_prefix
    ...
    with_routing do |set|
      set.draw do
        get 'wadus', to: 'people#index', as: 'wadus'
  ...
  def test_action_controller_gets_locale_setter
    @controller.respond_to?('set_locale_from_url')
  end

  def test_action_controller_gets_locale_suffix_helper
    @controller.respond_to?('locale_suffix')
  end

  def test_action_view_gets_locale_suffix_helper
    @controller.view_context_class.instance_methods.include?('locale_suffix')
  end
